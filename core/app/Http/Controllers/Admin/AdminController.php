...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $siteHistory['total_post']           = Post::count();
        $siteHistory['total_gallery_photos'] = Gallery::count();
        $siteHistory['total_donations']      = Donation::success()->sum('amount');
        $siteHistory['total_memberships']    = Membership::count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'siteHistory', 'depositsMonth', 'withdrawalMonth', 'months', 'trxReport', 'plusTrx', 'minusTrx'));
    }

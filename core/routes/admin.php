...
Route::middleware('admin')->group(function () {
    ...
    // Post
    Route::controller('PostManageController')->prefix('post')->name('post.')->group(function () {
        Route::get('list', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
        Route::get('comment/{id}', 'comment')->name('comment');
        Route::post('status/{id}', 'status')->name('comment.status');
    });

    // Gallery
    Route::controller('GalleryManageController')->prefix('gallery')->name('gallery.')->group(function () {
        Route::get('list', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
        Route::get('comment/{id}', 'comment')->name('comment');
        Route::post('status/{id}', 'status')->name('comment.status');
    ...
    // Donatin History
    Route::controller('DonationHistoryController')->prefix('donation')->name('donation.')->group(function () {
        Route::get('history', 'index')->name('index');
        Route::get('membership/history', 'membership')->name('membership');
    });

    //Statistic
    Route::controller('StatisticController')->prefix('donation')->name('donation.')->group(function () {

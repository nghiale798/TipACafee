                                ...
                                @forelse ($languages as $item)
                                    <tr>
                                        <td>
                                            <div class="user">
                                                <div class="thumb">
                                                    <img src="{{ getImage(getFilePath('flag') . '/' . $item->flag, getFileSize('flag')) }}"
                                                        class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @if ($item->id != 1)
                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to remove this language from this system?')"
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.language.manage.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" name="flag" type="file" required>
                            </div>
                            <div class="mt-2">
                                <small class="mt-3 text-muted"> @lang('Supported Files:')
                                    <b>@lang('.jpg'), @lang('.jpeg'), @lang('.png')</b>
                                    @lang('Image will be resized into') <b>{{ getFileSize('flag') }}</b> @lang('px')</b>
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input name="is_default" data-width="100%" data-height="40px" data-onstyle="-success" data-offstyle="-danger"
                                    data-bs-toggle="toggle" data-on="@lang('SET')" data-off="@lang('UNSET')" type="checkbox">
                            </div>
                        </div>
...
@push('breadcrumb-plugins')
    <button class="btn btn-sm btn-outline--primary" data-bs-toggle="modal" data-bs-target="#createModal" type="button"><i
            class="las la-plus"></i>@lang('Add New')</button>
    <button class="btn btn-sm btn-outline--info keyBtn" data-bs-toggle="modal" data-bs-target="#getLangModal" type="button"><i
            class="las la-code"></i>@lang('Language Keywords')</button>
@endpush

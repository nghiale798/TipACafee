                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-4 col-sm-6">
                                ...
                                <x-image-uploader class="w-100" id="uploadLogo" name="logo" :imagePath="siteLogo() . '?' . time()" :size="false" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Logo for Dark Background')</label>
                                <x-image-uploader class="w-100" darkMode="true" id="uploadLogoDark" name="logo_dark" :imagePath="siteLogo('dark') . '?' . time()" :size="false" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Favicon')</label>
                                <x-image-uploader class="w-100" id="uploadFavicon" name="favicon" :imagePath="siteFavicon() . '?' . time()" :size="false" :required="false" />
                            </div>
                        </div>

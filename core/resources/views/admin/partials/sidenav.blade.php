    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.donation.statistics') }}">
                    <a class="nav-link " href="{{ route('admin.donation.statistics') }}">
                        <i class="menu-icon las la-chart-pie"></i>
                        <span class="menu-title">@lang('Donation Statistics')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.category.*') }}">
                    <a class="nav-link " href="{{ route('admin.category.index') }}">
                        <i class="menu-icon las la-object-group"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive(['admin.post.index', 'admin.post.details', 'admin.post.comment']) }}">
                    <a class="nav-link " href="{{ route('admin.post.index') }}">
                        <i class="menu-icon las la-list"></i>
                        <span class="menu-title">@lang('All Posts')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive(['admin.gallery.index', 'admin.gallery.details', 'admin.gallery.comment']) }}">
                    <a class="nav-link " href="{{ route('admin.gallery.index') }}">
                        <i class="menu-icon las la-image"></i>
                        <span class="menu-title">@lang('Gallery Photos')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive(['admin.report*', 'admin.donation.membership', 'admin.donation.index'], 3) }}" href="javascript:void(0)">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Report') </span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive(['admin.report*', 'admin.donation.membership', 'admin.donation.index'], 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.donation.index') }}">
                                <a class="nav-link " href="{{ route('admin.donation.index') }}">
                                    <i class="menu-icon las la-circle"></i>
                                    <span class="menu-title">@lang('Donation History')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.donation.membership') }}">
                                <a class="nav-link " href="{{ route('admin.donation.membership') }}">
                                    <i class="menu-icon las la-circle"></i>
                                    <span class="menu-title">@lang('Membership History')</span>
                                </a>
                            </li>

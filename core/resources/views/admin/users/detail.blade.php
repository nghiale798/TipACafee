        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" title="Balance" style="2" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-money-bill-wave-alt" color="info" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}" title="Payments" style="2" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" icon="las la-wallet" color="success" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalWithdrawals) }}" title="Withdrawals" style="2" link="{{ route('admin.withdraw.log') }}?search={{ $user->username }}" icon="fas fa-wallet" color="danger" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $totalTransaction }}" title="Transactions" style="2" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-exchange-alt" color="primary" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $totalSupporterCount }}" title="Total Supporters" style="2" icon="las la-users" color="success" link="{{ route('admin.donation.index') }}?donation=1&search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $totalMemberCount }}" title="Total Members" style="2" icon="las la-user-friends" color="orange" link="{{ route('admin.donation.membership') }}?search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalSupporter) }}" title="Support Earning" style="2" icon="las la-money-bill-wave-alt" color="success" link="{{ route('admin.donation.index') }}?donation=1&search={{ $user->username }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget value="{{ $general->cur_sym }}{{ showAmount($totalMember) }}" title="Membership Earning" style="2" icon="las la-money-bill-wave" color="orange" link="{{ route('admin.donation.index') }}?donation=2&search={{ $user->username }}" />
                </div>

                                        ...
                                        @foreach ($item as $imgKey => $image)
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <x-image-uploader class="w-100" id="image-upload-input{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" :imagePath="getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->content->images->$imgKey->size)" :size="$section->content->images->$imgKey->size" :required="false" />
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    @elseif($k == 'images')
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader class="w-100" id="addImage{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" :imagePath="getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->element->images->$imgKey->size)" :size="$section->element->images->$imgKey->size" />
                                            </div>
                                        @endforeach
                                    ...
                                    @elseif($k == 'images')
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader class="w-100" id="updateImage{{ $loop->index }}" name="image_input[{{ @$imgKey }}]" :imagePath="getImage('', $section->element->images->$imgKey->size)" :size="$section->element->images->$imgKey->size" :required="false" />
        ...
        @if (!empty($templates))
            <div class="form-inline float-sm-end">
                <form action="{{ route('admin.frontend.import', $key) }}" method="post">
                    <div class="input-group">
                        @csrf
                        <select class="form-control form-control-sm border--primary h-auto" name="template_name">
